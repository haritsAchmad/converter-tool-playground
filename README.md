...
The API returns capabilities at runtime, so unavailable engines are not advertised. PDF-to-Office, legacy Office formats, and macro-enabled documents are intentionally not enabled; see [ROADMAP.md](ROADMAP.md).
