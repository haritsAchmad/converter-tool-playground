...
// this codebase didn't previously have at all: a real DOCX and a real
// multi-sheet XLSX, actually run through LibreOffice, producing a valid
// PDF. Skips where libreoffice/soffice isn't installed (this project's own
// Windows dev machine included, same as the poppler-dependent PDF tests),
// and runs for real in the Docker image and CI.
